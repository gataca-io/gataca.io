...
export default function Layout(props) {
  ...
  const removeAnalyticsCookies = () => {
    ...
    document.cookie = "_gat_UA-133561010-1" + "=; Path=/; Domain=.example.com; Expires=Thu, 01 Jan 1970 00:00:01 GMT;"
    document.cookie = "fs_uid" + "=; Path=/; Domain=.example.com; Expires=Thu, 01 Jan 1970 00:00:01 GMT;"
  }
  ...
  useEffect(() => {
    ...
    if (hubspotStateCookie) {
      ...
      // Advertisementent
      } else if (cookieStructure[0].includes("false")) {

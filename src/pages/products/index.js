                    ...
                    <div className={styles.productTextContainer}>
                      ...
                      <p
                        dangerouslySetInnerHTML={{
                          __html:
                            productsPage.findYourSolution.certify.description,
                        }}
                      />
                      <Link to={productsPage.findYourSolution.certify.ctaLink}>
                        ...
                        >
                          {" "}
                          {productsPage.findYourSolution.certify.ctaText}
                        </Button>
                      </Link>
                    </div>
                    {size.width > 672 && (
                      <div className={styles.credentialFloating}>
                        <img
                          ...
                          src={"/images/longArrowDown.svg"}
                        />
                        <img
                          className={styles.mainImg}
                          src={
                            productsPage.findYourSolution.certifyToWallet.image
                          }
                        />
                        <img
                          className={styles.arrow}
                  ...
                  <div className={styles.productFlow}>
                    ...
                    <div className={styles.productTextContainer}>
                      ...
                      <p
                        dangerouslySetInnerHTML={{
                          __html:
                            productsPage.findYourSolution.wallet.description,
                        }}
                      />
                      <Link to={productsPage.findYourSolution.wallet.ctaLink}>
                        ...
                        >
                          {" "}
                          {productsPage.findYourSolution.wallet.ctaText}
                        </Button>
                      </Link>
                    </div>
                    ...
                    {size.width > 672 && (
                      <div className={styles.qrFloating}>
                        ...
                        <img
                          className={styles.qr}
                          src={
                            productsPage.findYourSolution.walletToConnect.image
                          }
                        />
                        <img
                          className={styles.arrow}
                        ...
                        />
                        <img
                          className={styles.arrowCurved}
                          src={"/images/curvedArrow.svg"}
                        />
                        <img
                          className={styles.arrowCurvedTwo}
                          src={"/images/curvedArrowTwo.svg"}
                        />
                      </div>
                    )}
                  </div>
                  ...
                  <div className={styles.productFlow}>
                    ...
                    <div className={styles.productTextContainer}>
                      ...
                      <p
                        dangerouslySetInnerHTML={{
                          __html:
                            productsPage.findYourSolution.connect.description,
                        }}
                      />
                      <Link to={productsPage.findYourSolution.connect.ctaLink}>
                        ...
                        >
                          {" "}
                          {productsPage.findYourSolution.connect.ctaText}
                        </Button>
                      </Link>
                    </div>
                  </div>
